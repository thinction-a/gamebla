...
export default Header => {
    ...
    <header class="site-navbar js-sticky-header site-navbar-target" role="banner">
        <div class="container">
            ...
            <h1 class="mb-0 site-logo"><Link to="/" class="mb-0">SoftLand</Link></h1>
        </div>
        ...
        <div class="col-6 d-inline-block d-lg-none ml-md-0 py-3">
            <Router>
            <Link to="/" class="burger site-menu-toggle js-menu-toggle" data-toggle="collapse" data-target="#main-navbar">
                <span></span>
            </Link>
            </Router>
        </div>
